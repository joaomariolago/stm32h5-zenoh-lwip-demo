...
/* Get clock configuration */
  ...
  /* Compute the prescaler value to have TIM12 counter clock equal to 100KHz */
  ...
  */
  htim12.Init.Period = (100000U / 1000U) - 1U;
  ...
  if (status == HAL_OK)
  {
    ...
    if (status == HAL_OK)
    {
      if (TickPriority < (1UL << __NVIC_PRIO_BITS))
      {
        ...
        HAL_NVIC_SetPriority(TIM12_IRQn, TickPriority, 0U);
